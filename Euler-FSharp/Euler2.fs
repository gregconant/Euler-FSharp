...
//find the sum of the even-valued terms.
    ...
    //let result = evenFibby ((0,1), 0, 4000000) |> List.sum
    let result = evenFibby ((0,1), 0, 4000000)
    let output = List.map(fun x -> printf "%d" x) result
    printf "%d" result;;